...
# camera calibration coefficient
DIM = (200, 130)
...
def undistort(img, balance=1.0, dim2 = None, dim3 = None):
    ...
    # This is how scaled_K, dim2 and balance are used to determine the final K used to un-distort image. OpenCV document failed to m$
...
# initialize camera
cap = cv2.VideoCapture('sample3.avi')
